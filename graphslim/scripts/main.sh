...
# if [[ "${2}" == "gcondx" || "${2}" == "gcond" || "${2}" == "doscond" || "${2}" == "sgdd"|| "${2}" == "geom"|| "${2}" == "sfgc"|| "${2}" == "msgc" || "${2}" == "gcsntk"]]; then
...
if [[ "${2}" == "gcondx" || "${2}" == "gcond" || "${2}" == "doscond" || "${2}" == "sgdd"|| "${2}" == "geom"|| "${2}" == "sfgc"|| "${2}" == "msgc" || "${2}" == "gcsntk" ]]; then
    python train_gcond.py --dataset ${1} --method ${2} --reduction_rate ${3}
elif [[ "${2}" == "random" || "${2}" == "herding" || "${2}" == "kcenter" || "${2}" == "cent_p" || "${2}" == "cent_d" ]]; then
    python train_coreset.py --dataset ${1} --method ${2} --reduction_rate ${3}
else
    python train_coarsen.py --dataset ${1} --method ${2} --reduction_rate ${3}
fi
